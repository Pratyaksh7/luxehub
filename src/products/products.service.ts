...
export class ProductsService {
    ...
    async createProduct(user: any, body: any) {
        const createProduct = await new this.productModel(body);
        return createProduct.save();
    }

    async searchProduct(user: any, body: any) {
    ...
    async getAProduct(user: any, productId: string) {
    ...
    async updateAProduct(user: any, productId: string, body: any) {
    ...
    async deleteAProduct(user: any, productId: string) {
